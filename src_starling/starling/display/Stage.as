...
package starling.display
{
    ...
    public class Stage extends DisplayObjectContainer
    {
         ...
         *  field of game.view accordingly. */
        ...
        /** Specifies an angle (radian, between zero and PI) for the field of game.view. This value
         ...
         *  close to PI results in a fisheye lens effect. If the field of game.view is set to 0 or PI,
