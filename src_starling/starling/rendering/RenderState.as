...
package starling.rendering
{
    ...
    public class RenderState
    {
         ...
         *
         *  <p>The first 4 parameters define which area of the stage you want to game.view (the camera
         ...
         *  of the stage, with a field of game.view of 1.0 rad.</p>
         */
         ...
         *  their orientation relative to the game.view plane.
