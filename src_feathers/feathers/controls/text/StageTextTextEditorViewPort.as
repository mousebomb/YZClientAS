...
package feathers.controls.text
{
	...
	/**
	 * @private
	 * A text editor game.view port for the <code>TextArea</code> component that uses
	...
	public class StageTextTextEditorViewPort extends StageTextTextEditor implements ITextEditorViewPort
	{
		...
		/**
		 * The minimum space, in pixels, between the game.view port's top edge and
		 * the game.view port's content.
		 *
		 * @default 0
		 */
		...
		/**
		 * The minimum space, in pixels, between the game.view port's right edge and
		 * the game.view port's content.
		 *
		 * @default 0
		 */
		...
		/**
		 * The minimum space, in pixels, between the game.view port's bottom edge and
		 * the game.view port's content.
		 *
		 * @default 0
		 */
		...
		/**
		 * The minimum space, in pixels, between the game.view port's left edge and
		 * the game.view port's content.
		 *
		 * @default 0
		 */
