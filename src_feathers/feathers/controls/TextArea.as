...
package feathers.controls
{
	...
	public class TextArea extends Scroller implements IAdvancedNativeFocusOwner, IStateContext
	{
		...
		/**
		 * A function used to instantiate the text editor game.view port. If
		 ...
		 * properties on the text editor game.view port when it is first created. For
		 * instance, if you are skinning Feathers components without a theme,
		 * you might use this factory to set styles on the text editor game.view
		 * port.
		 *
		...
		protected function createTextEditor():void
		{
			...
			if(oldViewPort)
			{
				//the game.view port setter won't do this
				oldViewPort.dispose();
			}
		}
		...
		protected function setFocusOnTextEditorWithTouch(touch:Touch):void
		{
			...
			if(!this._textEditorHasFocus && isInBounds)
			{
				...
				//we account for the scroll position in the text editor game.view
