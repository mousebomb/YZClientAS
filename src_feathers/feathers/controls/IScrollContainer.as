...
package feathers.controls
{
	...
	public interface IScrollContainer extends IFeathersControl
	{
		 ...
		 * <code>Scroller</code> rather than delegating the call to the game.view
		 * port.
		 */
		 ...
		 * than delegating the call to the game.view port.
		 */
		 ...
		 * index rather than delegating the call to the game.view port.
		 */
		 ...
		 * the call to the game.view port.
		 */
		 ...
		 * rather than delegating the call to the game.view port.
		 */
		 ...
		 * delegating the call to the game.view port.
		 */
