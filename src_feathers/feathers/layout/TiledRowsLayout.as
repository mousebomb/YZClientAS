...
package feathers.layout
{
	...
	public class TiledRowsLayout extends EventDispatcher implements IVirtualLayout
	{
		 ...
		 *
		 * <p>If the game.view port's explicit or maximum width is not large enough
		 * to fit the requested number of columns, it will use fewer. If the
		 * game.view port doesn't have an explicit width and the maximum width is
		 ...
		 * If the game.view port's explicit or maximum height is not large enough to
