...
package feathers.layout
{
	...
	public interface ILayout extends IFeathersEventDispatcher
	{
		 ...
		 * scroll position changes. Useful for transforming items as the game.view
		 ...
		 * scroll into and out of the game.view port.
		 */
		 ...
		 * required to display the full bounds of the item in the game.view port,
		 ...
		 * the final bounds of the game.view port, which may be calculated in the
		 * layout() function.</p>
		 *
		 ...
		 * that will display the full bounds of the item within the game.view port.
		 * If the item is already fully displayed in the game.view port, the current
		 * scroll position will be returned unchanged.
		 *
		 * <p>While the item will be displayed in the game.view port without being
