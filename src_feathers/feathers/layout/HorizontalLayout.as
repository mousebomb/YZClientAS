...
package feathers.layout
{
	...
	public class HorizontalLayout extends EventDispatcher implements IVariableVirtualLayout, ITrimmedVirtualLayout
	{
		 ...
		 * the explicit width of the game.view port is set, then this value will be
		 * ignored. If the game.view port's minimum and/or maximum width are set,
		...
		/**
		 * Distributes the width of the game.view port equally to each item. If the
		 * game.view port width needs to be measured, the largest item's width will
		...
		public function layout(items:Vector.<DisplayObject>, viewPortBounds:ViewPortBounds = null, result:LayoutBoundsResult = null):LayoutBoundsResult
		{
			...
			for(var i:int = 0; i < itemCount; i++)
			{
				...
				else
				{
					...
					if(itemHeight > maxItemHeight)
					{
						...
						//case where the height of the game.view port needs to be
			...
			//the available width of the game.view port.
