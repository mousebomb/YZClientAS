...
package feathers.layout
{
	...
	public class TiledColumnsLayout extends EventDispatcher implements IVirtualLayout
	{
		 ...
		 *
		 * <p>If the game.view port's explicit or maximum height is not large enough
		 * to fit the requested number of rows, it will use fewer. If the
		 * game.view port doesn't have an explicit height and the maximum height is
		 ...
		 * if possible. If the game.view port's explicit or maximum width is not large
		 ...
		 * of the game.view port, the layout will be split into pages where each
