...
package feathers.motion
{
	 ...
	 * wipes a display object out of game.view, revealing another display object
	...
	public class Wipe
	{
		 ...
		 * old screen out of game.view to the left, animating the <code>width</code>
		...
		/**
		 * Creates a transition function for a screen navigator that wipes the
		 * old screen out of game.view to the right, animating the <code>x</code>
