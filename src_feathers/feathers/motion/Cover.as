...
package feathers.motion
{
	 ...
	 * slide a display object into game.view, animating the `x` or `y` property, to
	...
	public class Cover
	{
		 ...
		 * new screen into game.view to the left, animating the `x` property, to
		...
		/**
		 * Creates a transition function for a screen navigator that slides the
		 * new screen into game.view to the right, animating the `x` property, to
		 * cover up the old screen, which remains stationary.
		 *
		 * @see ../../../help/transitions.html#cover Transitions for Feathers screen navigators: Cover
		 * @see feathers.controls.StackScreenNavigator#pushTransition
		...
		/**
		 * Creates a transition function for a screen navigator that slides the
		 * new screen up into game.view, animating the `y` property, to cover up the
		...
		/**
		 * Creates a transition function for a screen navigator that slides the
		 * new screen down into game.view, animating the `y` property, to cover up the
		 * old screen, which remains stationary.
		 *
		 * @see ../../../help/transitions.html#cover Transitions for Feathers screen navigators: Cover
		 * @see feathers.controls.StackScreenNavigator#pushTransition
