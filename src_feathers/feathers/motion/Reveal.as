...
package feathers.motion
{
	 ...
	 * slides a display object out of game.view, animating the `x` or `y` property,
	...
	public class Reveal
	{
		 ...
		 * old screen out of game.view to the left, animating the `x` property, to
		...
		/**
		 * Creates a transition function for a screen navigator that slides the
		 * old screen out of game.view to the right, animating the `x` property, to
		 * reveal the new screen under it. The new screen remains stationary.
		 *
		 * @see ../../../help/transitions.html#reveal Transitions for Feathers screen navigators: Reveal
		 * @see feathers.controls.StackScreenNavigator#pushTransition
		...
		/**
		 * Creates a transition function for a screen navigator that slides the
		 * old screen up out of game.view, animating the `y` property, to reveal the
		...
		/**
		 * Creates a transition function for a screen navigator that slides the
		 * old screen down out of game.view, animating the `y` property, to reveal the
		 * new screen under it. The new screen remains stationary.
		 *
		 * @see ../../../help/transitions.html#reveal Transitions for Feathers screen navigators: Reveal
		 * @see feathers.controls.StackScreenNavigator#pushTransition
