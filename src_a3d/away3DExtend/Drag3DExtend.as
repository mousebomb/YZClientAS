package away3DExtend
{
	 ...
	 * @author J.C
	 */
	public class Drag3DExtend
	{
		private var _dragWay:String = "any";
//		private var _dragNormal:Vector3D = new Vector3D(1, 1, 1);
		
		public function set dragWay(v:String):void
		{
			_dragWay = v;
//			switch(v)
//			{
//				case "any":
//					_dragNormal = new Vector3D(1, 1, 1);
//					break;
//				case "x":
//					_dragNormal = new Vector3D(1, 0, 0);
//					break;
//				case "y":
//					_dragNormal = new Vector3D(0, 1, 0);
//					break;
//				case "z":
//					_dragNormal = new Vector3D(0, 0, 1);
//					break;
//			}
		}
		
		public function get dragWay():String
		{
			return _dragWay;
		}
		 ...
		 */
		public function Drag3DExtend(view:View3D, object3d:ObjectContainer3D = null, plane:String = PLANE_XZ)
		{
			_view = view;
			if(object3d)
			{
				_object3d = object3d;
				_offsetCenter.y = object3d.y;
			}
			_planeid = plane;
			updateNormalPlanes();
			init();
...
//			localIntersect = _intersect;
			
			var v:Vector3D = localIntersect;
