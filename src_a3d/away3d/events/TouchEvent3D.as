package away3d.events
{
	...
	public class TouchEvent3D extends Event
	{
		...
		/**
		 * The horizontal coordinate at which the event occurred in game.view coordinates.
		 */
		public var screenX:Number;
		
		/**
		 * The vertical coordinate at which the event occurred in game.view coordinates.
		 */
		public var screenY:Number;
		
		/**
		 * The game.view object inside which the event took place.
		 */
