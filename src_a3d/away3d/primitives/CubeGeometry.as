package away3d.primitives
{
	...
	public class CubeGeometry extends PrimitiveBase
	{
		 ...
		 * @param tile6 The type of uv mapping to use. When true, a texture will be subdivided in a 2x3 grid, each used
		 *     for a single face. When false, the entire image is mapped on each face.
		 */
