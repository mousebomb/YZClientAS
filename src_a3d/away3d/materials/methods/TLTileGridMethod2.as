...
package away3d.materials.methods
{
	 ...
	 * */
	public class TLTileGridMethod2 extends EffectMethodBase
	{
		 ...
		 * */
		public function TLTileGridMethod2(tileData:Array , gridT:Texture2DBase = null)
		{
			super();
		...
		override arcane function getFragmentCode(vo:MethodVO, regCache:ShaderRegisterCache, targetReg:ShaderRegisterElement):String
		{
			...
			code += "mul " + uv + ", " + uvReg + ", " + scaleRegister + ".xy\n" +
					getTex2DSampleCode(vo,uv,textureReg,_gridTexture,uv);
