package away3d.materials.methods
{
	...
	/**
	 * FresnelSpecularMethod provides a specular shading method that causes stronger highlights on grazing game.view angles.
	 */
	public class FresnelSpecularMethod extends CompositeSpecularMethod
	{
		 ...
		 * @param basedOnSurface Defines whether the fresnel effect should be based on the game.view angle on the surface (if true), or on the angle between the light and the game.view.
		...
		/**
		 * Defines whether the fresnel effect should be based on the game.view angle on the surface (if true), or on the angle between the light and the game.view.
		 */
		...
		/**
		 * The minimum amount of reflectance, ie the reflectance when the game.view direction is normal to the surface or light direction.
		 */
