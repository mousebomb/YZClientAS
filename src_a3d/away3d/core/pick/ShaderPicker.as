package away3d.core.pick
{
	...
	/**
	 * Picks a 3d object from a game.view or scene by performing a separate render pass on the scene around the area being picked using key color values,
	...
	public class ShaderPicker implements IPicker
	{
		 ...
		 * @param camera The camera used to game.view the hit object.
		 */
