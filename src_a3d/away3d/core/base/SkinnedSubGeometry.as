package away3d.core.base
{
	...
	public class SkinnedSubGeometry extends CompactSubGeometry
	{
		...
		protected var _jointWeightsData:Vector.<Number>;
		protected var _jointIndexData:Vector.<Number>;
		...
		protected var _jointIndicesInvalid:Vector.<Boolean> = new Vector.<Boolean>(8, true);
		...
		protected var _jointsPerVertex:int;

		protected var _condensedJointIndexData:Vector.<Number>;
		protected var _condensedIndexLookUp:Vector.<uint>; // used for linking condensed indices to the real ones
		protected var _numCondensedJoints:uint;
		...
		override public function disposeForStage3D(stage3DProxy:Stage3DProxy):void
		{
