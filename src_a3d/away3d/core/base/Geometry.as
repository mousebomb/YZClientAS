package away3d.core.base
{
	...
	{
		public static var DEF_GEO:Geometry = new Geometry();
		...
		public function disposeForStage3D():void
		{
			var numSubGeoms:uint = _subGeometries.length;
			...
			for (var i:uint = 0; i < numSubGeoms; ++i)
			{
				...
				subGeom.disposeForStage3D(StageFrame.stage3DProxy);
			}
		}

		/**
		 * Clears all resources used by the Geometry object, including SubGeometries.
		 * </br>释放当前几何几何体中所有的子几何数据对象
		 */
		 ...
		 * </br>根据Pixel Bender和PBPickingCollider更新SubGeometries中所有的在不同缓冲区中的顶点.
		 */
