package away3d.core.partition
{
	...
	// todo: provide markVisibleVolume to pass in another game.view volume to find all statics in the scene that intersect with target ViewVolume, for constructing game.view volumes more easily
	public class ViewVolume extends NodeBase
	{
		 ...
		 *
		 * @param minBound The minimum boundaries of the game.view volume (the bottom-left-near corner)
		 * @param maxBound The maximum boundaries of the game.view volume (the top-right-far corner)
		 * @param cellSize The size of cell subdivisions for the game.view volume. The default value is -1, meaning the game.view volume will not be subdivided. This is the value that should usually be used when setting visibility info manually.
		 */
