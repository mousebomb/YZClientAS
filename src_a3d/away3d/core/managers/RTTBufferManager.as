package away3d.core.managers
{
	 ...
	 * 普通的图形渲染流程中，最终结果是渲染到帧缓存中，最后显示到屏幕上，现在可以利用FBO等技术，
	 * 把图像渲染到纹理中，然后可以把纹理继续应用到场景绘制中，比如渲染一个场景A到纹理中，
	 * 在另一个场景B的一个电视屏幕上把刚才的纹理贴上去，就像是在播放A一样，
	 * 再比如各种镜子中的景象也是一样道理，阴影图（shadow mapping）也算是运用了RTT
	 */
	...
	public class RTTBufferManager extends EventDispatcher
	{
		...
		// needs to be stored per game.view of course
