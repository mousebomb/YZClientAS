package game.frameworks.chat.view.richText
{
    ...
    public class TextRenderer extends TextField
	{
		...
		{
			super();			
			var fontName:String = NotifyConst.DEFAULT_FONT_NAME;
			var format:TextFormat = new TextFormat(fontName, 13, 0x000000, false, false, false);
