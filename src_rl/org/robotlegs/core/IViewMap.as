...
package org.robotlegs.core
{
	...
	/**
	 * The Robotlegs ViewMap contract. All IViewMap automatic injections occur AFTER the game.view components are added to the stage.
	 */
	public interface IViewMap
	{
		...
		/**
		 * Map a game.view component class or interface for automatic injection
		 *
		 * @param type The concrete game.view Interface
		 */
		function mapType(type:Class):void;
		
		/**
		 * Unmap a game.view component class or interface
		 *
		 * @param type The concrete game.view Interface
		 */
		 ...
		 *
		 * @return game.view The <code>DisplayObjectContainer</code> to use as scope for this <code>IViewMap</code>
		 */
