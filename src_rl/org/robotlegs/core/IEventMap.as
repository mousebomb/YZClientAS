...
package org.robotlegs.core
{
	...
	public interface IEventMap
	{
		 ...
		 */
		function mapListener(dispatcher:*, type:String, listener:Function, eventClass:Class = null):void;
		 ...
		 * @param eventClass Optional Event class for a stronger mapping. Defaults to <code>starling.events.Event</code>.
		 */
		function unmapListener(dispatcher:*, type:String, listener:Function, eventClass:Class = null):void;
