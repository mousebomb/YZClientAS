...
package org.robotlegs.core
{
	...
	public interface IMediatorMap
	{
		...
		/**
		 * Map an <code>IMediator</code> to a game.view Class
		 *
		 * @param viewClassOrName The concrete game.view Class or Fully Qualified Class Name
		 * @param mediatorClass The <code>IMediator</code> Class
		 * @param injectViewAs The explicit game.view Interface or Class that the mediator depends on OR an Array of such Interfaces/Classes.
		 ...
		 * @param autoRemove Automatically remove an instance of Class <code>mediatorClass</code> when its <code>viewClass</code> leaves the ancestory of the context game.view
		 */
		 ...
		 *
		 * @param viewComponent An instance of the game.view Class previously mapped to an <code>IMediator</code> Class
		 ...
		 *
		 * @param viewComponent The game.view component for the <code>IMediator</code>
		 ...
		 * Remove a registered <code>IMediator</code> instance
		 *
		 * @param viewComponent The game.view that the <code>IMediator</code> was registered with
		 * @return The <code>IMediator</code> that was removed
		 */
		...
		/**
		 * Check if the game.view Class has been mapped or not
		 * 
		 * @param viewClassOrName The concrete game.view Class or Fully Qualified Class Name
		 * 
		 * @return Whether this game.view class has been mapped
		 */
		...
		/**
		 * Check if an <code>IMediator</code> has been registered for a game.view instance
		 *
		 * @param viewComponent The game.view that the <code>IMediator</code> was registered with
		 * @return Whether an <code>IMediator</code> has been registered for this game.view instance
		 */
		 ...
		 *
		 * @return game.view The <code>DisplayObjectContainer</code> to use as scope for this <code>IMediatorMap</code>
		 */
