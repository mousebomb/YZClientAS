...
package org.robotlegs.base
{
	...
	public class EventMap implements IEventMap
	{
		 ...
		 */
		public function mapListener(dispatcher:*, type:String, listener:Function, eventClass:Class = null):void
		{
			...
			var callback:Function = function(event:*):void
				{
		 ...
		 * @param useCapture
		 */
		public function unmapListener(dispatcher:*, type:String, listener:Function, eventClass:Class = null):void
		{
			if (!eventClass)
			{
				eventClass = Event;
		 ...
		 */
		protected function routeEventToListener(event:*, listener:Function, originalEventClass:Class):void
		{
