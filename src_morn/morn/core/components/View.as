...
package morn.core.components {
	...
	public class View extends Container {
		...
		protected static var uiClassMap:Object = {
			"Box": Box, "Button": UIButton, "CheckBox": CheckBox, "Clip": Clip, "ComboBox": ComboBox,
			"Component": Component, "Container": Container, "FrameClip": FrameClip, "HScrollBar": HScrollBar, "HSlider": HSlider, 
			"Image": UIImage, "Label": Label, "LinkButton": LinkButton, "List": List, "Panel": Panel, "ProgressBar": ProgressBar, 
			...
			"HBox": HBox, "VBox": VBox, "TextureClip":TextureClip};
		...
		protected static function createCompByJSON(json:Object, comp:Component = null, view:View = null):Component {
			...
			if (child) {
				for each (var node:Object in child) {
					if (comp is List && node.props.name == "render") {
						List(comp).itemRender = node;
					} else {
						comp.addChild(createCompByJSON(node, null, view));
					}
				}
			}
